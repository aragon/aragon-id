...
module.exports = {
    assertJump(block, message = "should have failed with invalid JUMP") {
        return assertThrows(block, message, "invalid JUMP")
    },

    assertInvalidOpcode(block, message = "should have failed with invalid opcode") {
        return assertThrows(block, message, "invalid opcode")
    },

    assertRevert(block, message = "should have failed by reverting") {
